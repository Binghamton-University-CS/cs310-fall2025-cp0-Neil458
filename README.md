Full Name: Neil Abhichandani
GitHub ID: Neil458
Binghamton CS userid: nabhichandan
Discord name: jellofficial (Neil)
...
please describe briefly here: I belive I completed it correctly just not sure if the output of my code is correct when ran.
